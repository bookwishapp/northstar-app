  ...
  try {
    ...
    const response = {
      ...
      template: {
        ...
        characterDescription: holiday.template?.characterTone,
        tone: holiday.template?.characterTone,
        headerImageKey: holiday.template?.headerKey,
        envelopeBackgroundKey: holiday.template?.envelopeBackgroundKey,
        signatureImageKey: holiday.template?.signatureKey,
        waxSealImageKey: holiday.template?.waxSealKey,
        emailHeaderImageKey: holiday.template?.emailHeaderKey,
      },
